...
<div class="row">
  <div class="col-12">
    <div class="jumbotron jumbotron-fluid" style="background-image: url('portal.jpg'); padding-bottom: 100px; background-size:cover;">
      <div class="container" style="padding-top:10px; padding-bottom: 15px;">
        <h1 class="display-4" style="font-weight: bold;">Job Portal</h1>
        <p class="lead"><strong>Best Jobs available matching your skills</strong></p>
      </div>
    </div>
  </div>
</div>
...
<div class="row">
  ...
  if($result->num_rows>0){
    while($rows=$result->fetch_assoc()){
      echo'
      <div class="col-md-4">
      <div class="jobs" style="margin-top: 20px;">
